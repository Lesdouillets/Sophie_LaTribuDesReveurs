            ...
            trailingInfoButtons: [
              ...
              },
              {
                ...
                blocks: [
                  ...
                  { type: "normal", text: "- 🥛 **<u>Conservation du lait</u>** *(à compléter avec ton tableau)*" },
                  { type: "normal", _noBorder: true, text: "<div style=\"background:#fff;border:1px solid #cbd5e0;border-radius:8px;padding:12px 14px;margin:8px 0\"><div style=\"font-weight:700;margin-bottom:8px\">📏 <u>Taille estomac</u></div><table style=\"border-collapse:collapse;width:100%;font-size:13px;line-height:1.4;background:#fff\"><thead><tr><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Âge</th><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Volume</th><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Équivalent</th></tr></thead><tbody><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">1 mois</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">80-150 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">œuf / demi verre d'eau</td></tr><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">6 mois</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">150 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">kiwi</td></tr><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">1 an</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">250 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">pomme / verre d'eau</td></tr></tbody></table></div>" }
                ]
              }
            ]
          }
