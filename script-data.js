          ...
          { type: "normal", _leftTitle: "Alimentation et sommeil",
            ...
            trailingInfoButtons: [
              ...
              },
              {
                ...
                blocks: [
                  { type: "normal", text: "- 👍 **Les signes que tout va bien :**\n  - **Lait** qui coule à la **commissure des lèvres**\n  - **Mains ouvertes** en fin de repas\n  - Un air **groggi**" },
                  { type: "normal", text: "- 👎 **Les signes d'un bébé qui a FAIM :**\n  - la **courbe de poids** qui stagne ou diminue\n  - Demande de **tétine : coupe-faim**\n  - bébé qui **réclame très souvent** (même la nuit)\n  - bébé qui **finit son biberon** mais qui pourrait prendre +\n  - **Absence de régurgitation** après le bib\n  - Beaucoup de **pleurs** en fin de journée et la nuit (vers 3 mois : « nehh »)\n  - **Pas de signe de satiété** : mains ouvertes, bébé groggy, lait qui ressort" },
                  { type: "normal", text: "- 🥛 **Conservation du lait** *(à compléter avec ton tableau)*" },
                  { type: "normal", _noBorder: true, text: "<div style=\"font-weight:700;margin:8px 0 6px\">📏 Taille estomac</div><table style=\"border-collapse:collapse;width:100%;font-size:13px;line-height:1.4;background:#fff\"><thead><tr><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Âge</th><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Volume</th><th style=\"background:#dbeafe;border:1px solid #94a3b8;padding:8px;color:#1e3a8a;text-align:left\">Équivalent</th></tr></thead><tbody><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">1 mois</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">80-150 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">œuf / demi verre d'eau</td></tr><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">6 mois</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">150 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">kiwi</td></tr><tr><td style=\"border:1px solid #94a3b8;padding:6px 10px;font-weight:700\">1 an</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">250 mL</td><td style=\"border:1px solid #94a3b8;padding:6px 10px\">pomme / verre d'eau</td></tr></tbody></table>" }
                ]
              }
            ]
          }
