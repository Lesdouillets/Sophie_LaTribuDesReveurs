      ...
      blocks: [
        ...
        },
        {
          ...
          blocks: [
            ...
            {
              type: "option", label: "Nuits complètes (mais besoin de tps d'alimentation car PETIT)", style: "purple",
              blocks: [
                { type: "normal", text: "- bébé trop petit ⇒ Il a encore **besoin de tps d'alimentation** la nuit\n- Son estomac n'est pas assez gros pour **\"TENIR\"** toute la nuit\n- ⇒ Il a donc encore **besoin de tps d'alimentation** la nuit" }
              ]
            },
            {
              type: "option", label: "Nuits complètes (mais besoin de rattrapage de courbe)", style: "purple",
              blocks: [
                { type: "normal", text: "- Aujourd'hui, votre enfant a besoin de faire un **rattrapage de courbe**\n- Il est possible que les **tps d'alimentation** la nuit soient encore présents quelque temps\n- Mais c'est **TEMPORAIRE** :\n  - le temps que sa **courbe de poids** remonte\n  - et que ses **apports alimentaires** se remettent en journée\n- ⇒ Il a donc encore **besoin de tps d'alimentation** la nuit de manière **temporaire**" }
              ]
            },
            {
      ...
      },
      {
        ...
        children: [
            ...
            blocks: [
              // ─── 2-4 mois (4 siestes) ─────────────────────────────────────
              {
                ...
                rows: [
                  ...
                  { kind: "te", label: "Temps d'Éveil 5 : Réveil, change, manger, rituel, dernier tps nutrition", durationMin: 90, durationRange: "1h30" },
              ...
              // ─── 4-6 mois (3 siestes) ─────────────────────────────────────
              {
                ...
                rows: [
                  ...
                  { kind: "te", label: "Temps d'Éveil 4 : Réveil, change, manger, rituel, dernier tps nutrition", durationMin: 105, durationRange: "1h30-1h45" },
              ...
              // ─── 6-8 mois (3 siestes) — basé sur sheet5 "Emploi 7 mois" ──
              {
                ...
                rows: [
                  ...
                  { kind: "te", label: "Temps d'Éveil 4 : Réveil, change, manger, rituel, dernier tps nutrition", durationMin: 120, durationRange: "1h30-2h" },
              ...
              // ─── 8-15 mois (2 siestes) — basé sur sheet7 "Emploi 8-14mois" ───
              {
                ...
                rows: [
                  ...
                  { kind: "te", label: "Temps d'Éveil 3 : Réveil, change, manger, rituel, dernier tps nutrition", durationMin: 180, durationRange: "jusque 4h" },
              ...
              // ─── 15-20 mois (2 siestes) — basé sur sheet8 "Emploi 14-20mois" ───
              {
                ...
                rows: [
                  ...
                  { kind: "te", label: "Temps d'Éveil 3 : Réveil, change, manger, rituel, dernier tps nutrition", durationMin: 210, durationRange: "jusque 4h" },
          ...
          { id: "rythme_rituel_du_soir", label: "Rituel du soir", cardLabel: "Rituel du soir", cardEmoji: "🌙",
            ...
            blocks: [
              {
                type: "normal", _leftTitle: "0-2 mois",
                showIfAgeMaxMonths: 2,
                text: "- Si on **continue dans la journée**, on peut **parler rapidement** du **rituel du soir**\n- Ça dure entre 20 et 30 min :\n  - Pas trop long : pour que l'enfant **se rappelle** que c'est **toujours le rituel du soir**\n  - Pas trop court : pour que l'enfant puisse se **mettre en mode « dodo »**\n- Je vous encourage à faire **2 tps d'alim** sur le **dernier temps d'éveil** : **après la sieste** ET **pdt le rituel**[if_alim:Allaitement au biberon,Allaitement mixte,Biberon lait infantile] <span style=\"color:#dc2626\">— ça rappelle les **tétées groupées** des BB allaités</span>[/if_alim]\n\n<div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:10px 14px;margin:10px 0;font-size:14px;line-height:1.5;color:#7c2d12\">⚠️ <strong>S'il/si elle s'endort au bib/sein</strong> : Déplacer le tps d'alimentation <strong>AVANT le bain</strong></div>\n\n**Étapes du rituel** :\n[if_pb_not:rgo_seul]<ol style=\"margin:6px 0 14px 22px;padding:0;line-height:1.75\"><li>{{infobtn:0}}<strong>Bain</strong> <em>(10 min max)</em> avec <strong>chanson mantra</strong><ul style=\"margin:4px 0 8px 18px;list-style:disc\"><li>Repère temporel</li><li>Immersion du bain = apaisant</li></ul></li><li><strong>« Bonne nuit »</strong> aux personnes qui ne prennent pas part au rituel, à l'extérieur de la chambre</li><li><strong>Fermer les rideaux</strong></li><li><strong>Tps de nutrition</strong> dans la chambre avec la <strong>lumière TAMISÉE</strong>, <span style=\"color:#dc2626\">⚠️ <strong>SANS s'endormir</strong></span></li><li><strong>Câlins et bisous</strong></li><li><strong>Emmaillotage possible</strong></li><li><strong>Chanson du dodo</strong></li><li><strong>Posez l'enfant dans le lit, ÉVEILLÉ</strong>, avec <strong>doudou</strong></li></ol>[/if_pb_not][if_pb:rgo_seul]<ol style=\"margin:6px 0 14px 22px;padding:0;line-height:1.75\"><li><strong>Tps de nutrition</strong> dans la chambre avec la <strong>lumière TAMISÉE</strong>, <span style=\"color:#dc2626\">⚠️ <strong>SANS s'endormir</strong></span>, <em>ça vous permettra de le verticaliser durant tout son temps d'éveil</em></li><li>{{infobtn:0}}<strong>Bain</strong> <em>(10 min max)</em> avec <strong>chanson mantra</strong><ul style=\"margin:4px 0 8px 18px;list-style:disc\"><li>Repère temporel</li><li>Immersion du bain = apaisant</li></ul></li><li><strong>« Bonne nuit »</strong> aux personnes qui ne prennent pas part au rituel, à l'extérieur de la chambre</li><li><strong>Fermer les rideaux</strong></li><li><strong>Câlins et bisous</strong></li><li><strong>Emmaillotage possible</strong></li><li><strong>Chanson du dodo</strong></li><li><strong>Posez l'enfant dans le lit, ÉVEILLÉ</strong>, avec <strong>doudou</strong></li></ol>[/if_pb]\n\n<div style=\"background:#fee2e2;border:2px solid #dc2626;border-radius:10px;padding:10px 14px;margin:10px 0;font-size:14px;line-height:1.5;color:#991b1b\"><strong>⛔ Pas d'histoire avant 18 mois</strong> — trop stimulant</div>",
                inlineInfoButtons: [
                  {
                    label: "Eau florale",
                    title: "💡 Eau florale",
