    ...
    blocks: [
      ...
      { type: "obj_rappel", _leftTitle: "Objectifs", _leftTitleStyle: "background:#2d3f5c;color:#fff",
        ...
        embeddedActions: [
        {
          ...
          blocks: [
            { type: "question", _leftTitle: "Questions ?", _leftTitleStyle: "background:#dcfce7;color:#166534;--cat-main:#166534", text: "Est-ce qu'il vous **reste des questions** ?" },
            { type: "question", _leftTitle: "Quand ?", _leftTitleStyle: "background:#dcfce7;color:#166534;--cat-main:#166534", text: "**QUAND** est-ce que vous **PENSEZ** **pouvoir commencer** à **mettre ces changements en place** ?" },
            {
            ...
            { type: "question", _leftTitle: "Dernière question", _leftTitleStyle: "background:#dcfce7;color:#166534;--cat-main:#166534", text: "Moi, j'ai une **dernière question** pour VOUS qui est **très importante** :<br>⇒ Comment vous **vous sentez LÀ,** à **l'idée de mettre** tout ceci **en place** ?" },
            { type: "normal", _leftTitle: "Plein motivation", _leftTitleStyle: "background:#dcfce7;color:#166534;--cat-main:#166534", text: "- C'est super ! J'entends **plein de motivation** ! C'est génial !\n- Je vous **envoie** plein d'**énergie positive / bonnes ondes**\n- Je **vous souhaite** que les **nuits/siestes** de [prénom_enfant] **s'apaisent rapidement**, et que **les vôtres suivent** tout **aussi vite**.\n- Bonne journée !" },
        ...
        },
        {
          ...
          blocks: [
            { type: "normal", _leftTitle: "Merci !", _leftTitleStyle: "background:#fef2f2;color:#7f1d1d;--cat-main:#dc2626", text: "- Ok je **vous entends**\n- Et **merci de me le dire** !" },
            {
