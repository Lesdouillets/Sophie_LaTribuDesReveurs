          ...
          { id: "rythme_siestes", label: "Siestes", cardLabel: "Siestes", cardEmoji: "💤",
            ...
            blocks: [
              ...
              { type: "normal", showIfSieste: "15m-3a",
                text: "<div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:10px 14px;font-size:14px;line-height:1.6;color:#7c2d12;margin-right:220px\">💡 Cette sieste est <strong>importante et nécessaire</strong> pour [prénom_enfant] puisqu'elle permet de <strong>marquer une pause</strong> et <strong>recharger ses batteries</strong> pour la <strong>2ème partie de la journée</strong>.</div>",
                trailingInfoButtons: [
                  {
                    label: "Pourquoi est-ce + difficile pour les siestes que pour la nuit ?",
                    title: "Pourquoi est-ce + difficile pour les siestes que pour la nuit ?",
              ...
              { type: "normal", showIfSieste: "4a-plus-tc",
                text: "<div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:10px 14px;font-size:14px;line-height:1.6;color:#7c2d12\">💡 Ce <strong>temps calme</strong> est <strong>important et nécessaire</strong> pour [prénom_enfant] puisqu'il permet de <strong>marquer une pause</strong> et <strong>recharger ses batteries</strong> pour la <strong>2ème partie de la journée</strong>.</div>"
              }
            ]
          },
