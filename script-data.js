          ...
          { id: "rythme_siestes", label: "Siestes", cardLabel: "Siestes", cardEmoji: "💤",
            ...
            blocks: [
              ...
              { type: "normal", showIfSieste: "2-4m",
                text: "<div style=\"font-weight:800;font-size:15.5px;color:#1e293b;margin-bottom:8px\">Temps d'alim = début temps d'éveil</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.75\"><li>Je vous conseille de proposer un <strong>temps d'alimentation</strong> <strong>au début</strong> de <strong>chaque temps d'éveil,</strong><br>⇒ C'est le <strong>moment idéal</strong> pour lui, puisqu'il aura toute l'<strong>énergie nécessaire</strong> pour <strong>boire efficacement</strong> !</li></ul><div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:10px 14px;margin-top:12px;font-size:14px;line-height:1.6;color:#7c2d12\"><details><summary style=\"cursor:pointer;font-weight:700;list-style:none;display:flex;align-items:center;justify-content:space-between;gap:10px\">💡 Pourquoi est-ce + difficile pour les siestes que pour la nuit ?<span style=\"font-size:14px;transition:transform 0.2s\">▾</span></summary><ul style=\"margin:10px 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Il faut savoir, qu'<strong>en journée,</strong> le <strong>corps ne sécrète pas de mélatonine</strong> (hormone du sommeil)<br>⇒ Ça <strong>explique pourquoi</strong>, c'est un peu <strong>+ difficile</strong> de <strong>s'endormir, en journée, pour la sieste</strong></li><li>L'<strong>acquisition des siestes</strong> prend donc <strong>+ de temps</strong> que l'<strong>acquisition du sommeil de nuit</strong></li><li>En général, les siestes <strong>s'améliorent progressivement</strong>, sur <strong>1 à 2 mois</strong>.<br>⇒ Donc, il est <strong>important</strong> de rester <strong>persévérant et régulier</strong> dans la <strong>proposition des siestes</strong> pour votre enfant</li></ul></details></div><style>details[open] > summary > span:last-child { transform: rotate(180deg); } summary::-webkit-details-marker { display: none; }</style>"
              }
            ]
          },
