      ...
      },
      {
        ...
        children: [
          { id: "nutri_lait", label: "Lait", cardLabel: "Lait", cardEmoji: "🍼",
            ...
            {
              type: "grouped_block",
              _leftTitle: "Nutrition la nuit 🌛",
              _leftTitleStyle: "background:#e8c19a;color:#a05a1c;--cat-main:#d4845a",
              blocks: [
                {
                  type: "option", label: "👶 Moins de 6 mois (rattrapage de courbe)", style: "action", mutexGroup: "nutri-nuit",
                  ...
                  blocks: [
                    ...
                    { type: "normal", _noBorder: true, text: "<div style=\"display:flex;gap:12px;margin:8px 0;flex-wrap:wrap\"><div style=\"flex:1;min-width:280px;border:3px dashed #a78bfa;background:#f5f0ff;padding:12px 16px;border-radius:8px;line-height:1.55;color:#1f2937;box-shadow:0 2px 8px rgba(167,139,250,0.18)\"><div style=\"margin-bottom:6px;font-weight:700\"><u><em>OPTION : Rattrapage de courbe :</em></u></div><div>C'est <strong>encore + vrai</strong> quand on fait un <strong>« rattrapage de courbe » :</strong></div><ul style=\"margin:6px 0 0 20px;padding:0;list-style:disc\"><li>Les <strong>biberons de nuit</strong> vont être <strong>maintenus</strong> pour <strong>augmenter les apports sur 24h</strong></li><li>mais <strong>petit à petit</strong>, les <strong>apports</strong> vont se CONCENTRER <strong>en journée</strong></li><li>et les <strong>réveils alimentaires</strong> vont peu à peu <strong>disparaitre</strong></li></ul></div><div style=\"flex:1;min-width:280px;border:3px dashed #a78bfa;background:#f5f0ff;padding:12px 16px;border-radius:8px;line-height:1.55;color:#1f2937;box-shadow:0 2px 8px rgba(167,139,250,0.18)\"><div style=\"margin-bottom:6px;font-weight:700\"><u><em>OPTION : Dépendance au bib :</em></u></div><div>Ce qu'il faut <strong>garder en tête</strong>, c'est que <strong>derrière ces réveils</strong>, il peut y avoir à la fois :</div><ol style=\"margin:6px 0 0 22px;padding:0;list-style:decimal\"><li>un <strong>besoin de manger</strong></li><li><strong>et/ou</strong> un <strong>besoin de retrouver ses conditions d'endormissement</strong> puisque sa <strong>stratégie d'endormissement</strong> est <strong>dépendante</strong> du <strong>biberon</strong><div style=\"margin-top:4px\">⇒ Et très souvent, les <strong>2 se mélangent !</strong></div></li></ol><div style=\"margin-top:10px\">Donc :</div><ol style=\"margin:6px 0 0 22px;padding:0;list-style:decimal\"><li><strong>D'une part,</strong> on va d'abord <strong>s'assurer que tous ses besoins sont comblés</strong></li><li><strong>Si c'est le cas,</strong> on va pouvoir <strong>l'accompagner</strong> dans la <strong>recherche de nouvelles stratégies d'endormissement AUTONOMES</strong><div style=\"margin-top:4px\">⇒ <strong>je vous expliquerai</strong> un peu plus tard <strong>comment faire</strong> pour <strong>l'accompagner s'il a des émotions !</strong></div></li></ol></div></div>" },
                ...
                {
                  type: "option", label: "Plus de 6 mois : Rattrapage de courbe", style: "action", mutexGroup: "nutri-nuit",
