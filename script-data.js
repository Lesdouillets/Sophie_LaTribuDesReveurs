  ...
  conditional: [
    ...
    // ─── ORGANISATION DE LA JOURNÉE ──────────────────────
    {
      ...
      blocks: [
        ...
        { type: "option_banner", leverId: "rythme_reveil_decalage", emoji: "✅", showIfPb: "rythme_reveil_decalage", variant: "green" },
        { type: "normal", showIfPb: "rythme_reveil_decalage", text: "- Aujourd'hui, **[prénom_enfant]** est **[couche_couchee] à** `XX` h et **se lève à** `XX` h\n  ⇒ C'est-à-dire qu'[il_elle] dort `XX` h par nuit\n- Or, à son âge, un enfant **a besoin** d'environ `XX à XX` h **de nuit**\n  ⇒ Donc **ce réveil** à `XX` h est **logique**\n  ⇒ [il_elle] a **DÉJÀ EU sa nuit** et **peut commencer sa journée.**\n\n- Autrement dit, **ce n'est PAS** qu'[il_elle] se **réveille « trop tôt »**,\n  ⇒ C'est simplement que **son rythme** est un peu **en avance par rapport à VOTRE journée**" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_fatigue", emoji: "😵", showIfPb: "rythme_reveil_fatigue", variant: "green" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_relationnel", emoji: "💬", showIfPb: "rythme_reveil_relationnel", variant: "green" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_mange", emoji: "🍼", showIfPb: "rythme_reveil_mange", variant: "green" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_faim", emoji: "🥺", showIfPb: "rythme_reveil_faim", variant: "green" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_dependance", emoji: "🪑", showIfPb: "rythme_reveil_dependance", variant: "green" },
        ...
        { type: "option_banner", leverId: "rythme_reveil_bruit", emoji: "🔊", showIfPb: "rythme_reveil_bruit", variant: "green" },
