                      ...
                      items: [
                        {
                          ...
                          blocks: [
                            { type: "normal", text: "- **Avant** l'âge de **6 mois**, il est **possible d'avoir ENCORE** des **temps de nutrition la nuit**\n  ⇒ **L'estomac** d'un enfant n'est **pas assez gros** pour **\"tenir\" toute une nuit**\n\n- Il est AUSSI possible que pendant **un temps, les biberons de nuit** avaient **disparu**\n  - et puis, avec **un pic de croissance**,\n  - les **prises alimentaires nocturnes re-prennent** pendant quelques temps\n  - ⇒ c'est **NORMAL**" },
                            { type: "normal", _noBorder: true, text: "<div style=\"display:flex;gap:10px;margin:8px 0;flex-wrap:wrap\"><div style=\"flex:1;min-width:240px;max-width:380px;border:3px dashed #7c3aed;background:#f5f0ff;padding:8px 14px;border-radius:14px;line-height:1.45;color:#1f2937;font-size:13px;box-shadow:0 2px 8px rgba(124,58,237,0.18)\"><div style=\"margin-bottom:4px;font-weight:700\"><u><em>OPTION : Rattrapage de courbe :</em></u></div><div>C'est <strong>encore + vrai</strong> quand on fait un <strong>« rattrapage de courbe » :</strong></div><ul style=\"margin:4px 0 0 18px;padding:0;list-style:disc\"><li>Les <strong>biberons de nuit</strong> vont être <strong>maintenus</strong> pour <strong>augmenter les apports sur 24h</strong></li><li>mais <strong>petit à petit</strong>, les <strong>apports</strong> vont se CONCENTRER <strong>en journée</strong></li><li>et les <strong>réveils alimentaires</strong> vont peu à peu <strong>disparaitre</strong></li></ul></div><div style=\"flex:1;min-width:240px;max-width:380px;border:3px dashed #7c3aed;background:#f5f0ff;padding:8px 14px;border-radius:14px;line-height:1.45;color:#1f2937;font-size:13px;box-shadow:0 2px 8px rgba(124,58,237,0.18)\"><div style=\"margin-bottom:4px;font-weight:700\"><u><em>OPTION : Dépendance au bib :</em></u></div><div>Ce qu'il faut <strong>garder en tête</strong>, c'est que <strong>derrière ces réveils</strong>, il peut y avoir à la fois :</div><ol style=\"margin:4px 0 0 20px;padding:0;list-style:decimal\"><li>un <strong>besoin de manger</strong></li><li><strong>et/ou</strong> un <strong>besoin de retrouver ses conditions d'endormissement</strong> puisque sa <strong>stratégie d'endormissement</strong> est <strong>dépendante</strong> du <strong>biberon</strong><div style=\"margin-top:3px\">⇒ Et très souvent, les <strong>2 se mélangent !</strong></div></li></ol><div style=\"margin-top:8px\">Donc :</div><ol style=\"margin:4px 0 0 20px;padding:0;list-style:decimal\"><li><strong>D'une part,</strong> on va d'abord <strong>s'assurer que tous ses besoins sont comblés</strong></li><li><strong>Si c'est le cas,</strong> on va pouvoir <strong>l'accompagner</strong> dans la <strong>recherche de nouvelles stratégies d'endormissement AUTONOMES</strong><div style=\"margin-top:3px\">⇒ <strong>je vous expliquerai</strong> un peu plus tard <strong>comment faire</strong> pour <strong>l'accompagner s'il a des émotions !</strong></div></li></ol></div></div>" },
                            { type: "normal", text: "- **En attendant,** je vous **conseillerai de TOUJOURS :**\n  - **Dissocier l'alimentation et le sommeil**\n    - c'est à dire, ESSAYEZ qu'il ne **s'endorme PAS** sur son **biberon**\n    - en le **stimulant un petit peu** pendant la **prise alimentaire** *(ex : petite caresse sur la joue/le pied)*\n    - et assurez vous qu'il soit **POSE au maximum EVEILLE** dans son lit\n  - Durant la **nuit**, veillez à ce que :\n    - les **lumières** soient **basses**\n    - et que **votre voix reste calme.**\n      ⇒ Il est important à cet âge que votre enfant comprenne que :\n      - **la nuit est faite pour dormir**\n      - et **non pour jouer**" }
                          ]
                        },
                        {
                          ...
                          blocks: [
                            { type: "normal", text: "- Quand on fait un **\"rattrapage de courbe\" :**\n  - c'est **normal**, qu'au **début**, il y ait **ENCORE** des **temps de nutrition la nuit**\n  - mais **petit à petit**, les **apports** vont se CONCENTRER **en journée**\n  - et les **réveils alimentaires** vont peu à peu **disparaitre**" },
                            { type: "normal", _noBorder: true, text: "<div style=\"display:flex;margin:8px 0\"><div style=\"max-width:380px;border:3px dashed #7c3aed;background:#f5f0ff;padding:8px 14px;border-radius:14px;line-height:1.45;color:#1f2937;font-size:13px;box-shadow:0 2px 8px rgba(124,58,237,0.18)\"><div style=\"margin-bottom:4px;font-weight:700\"><u><em>OPTION : Dépendance au bib :</em></u></div><div>Et une fois, que <strong>sa courbe</strong> sera <strong>en hausse</strong>,</div><ul style=\"margin:4px 0 0 18px;padding:0;list-style:disc\"><li>On va <strong>pouvoir l'accompagner</strong> vers la <strong>découverte de nouvelle stratégie d'endormissement</strong></li><li>qui n'<strong>inclus PAS le biberon</strong></li></ul><div style=\"margin-top:6px\">⇒ <strong>je vous expliquerai</strong> un peu plus tard <strong>comment faire</strong> pour <strong>l'accompagner s'il a des émotions !</strong></div></div></div>" },
                            { type: "normal", text: "- **En attendant,** je vous **conseillerai de TOUJOURS** :\n  - **Dissocier l'alimentation et le sommeil**\n    - c'est à dire, ESSAYEZ qu'il ne **s'endorme PAS** sur son **biberon**\n    - en le **stimulant un petit peu** pendant la **prise alimentaire** *(ex : petite caresse sur la joue/le pied)*\n    - et assurez vous qu'il soit **POSE au maximum EVEILLE** dans son lit\n  - Durant la **nuit**, veillez à ce que :\n    - les **lumières** soient **basses**\n    - et que **votre voix reste calme.**\n      ⇒ Il est important à cet âge que votre enfant comprenne que :\n      - **la nuit est faite pour dormir**\n      - et **non pour jouer**" }
                          ]
                        },
                        {
                          ...
                          blocks: [
                            { type: "normal", text: "- Avec une **dépendance au biberon** la nuit, on va d'abord **s'assurer que tous ses besoins sont comblés** en JOURNEE\n\n- **Si c'est le cas,** et que votre enfant **a besoin du sein/du biberon pour s'endormir**\n  alors vous **pouvez l'accompagner** dans la **recherche de nouvelles stratégies d'endormissement AUTONOMES**\n  ⇒ **je vous expliquerai** un peu plus tard **comment faire** pour **l'accompagner s'il a des émotions !**" },
                            { type: "normal", text: "- **En attendant,** je vous **conseillerai de TOUJOURS :**\n  - **Dissocier l'alimentation et le sommeil**\n    - c'est à dire, ESSAYEZ qu'il ne **s'endorme PAS** sur son **biberon**\n    - en le **stimulant un petit peu** pendant la **prise alimentaire** *(ex : petite caresse sur la joue/le pied)*\n    - et assurez vous qu'il soit **POSE au maximum EVEILLE** dans son lit\n  - Durant la **nuit**, veillez à ce que :\n    - les **lumières** soient **basses**\n    - et que **votre voix reste calme.**\n      ⇒ Il est important à cet âge que votre enfant comprenne que :\n      - **la nuit est faite pour dormir**\n      - et **non pour jouer**" }
                          ]
                        }
                      ]
