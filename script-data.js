          ...
          items: [
            {
              ...
              blocks: [
                ...
                { type: "vicious_circle", showIfPb: "rythme_te_trop_long", steps: ["Temps d'éveil long", "Fatigue", "Sécrétion de cortisol", "Difficulté à l'endormissement"] },
                { type: "normal", showIfPb: "rythme_te_trop_long", text: "- Grosso modo, MÊME SI ÇA peut **paraître un peu paradoxal** :\n  - **PLUS** les **temps d'éveil sont longs**\n  - **PLUS** **[prénom_enfant]** est **[fatigue_fatiguee]**,\n  - **PLUS** son **corps VA [le_la] AIDER** à **rester [eveille_eveillee]**" },
                ...
                { type: "normal", showIfPb: "rythme_te_court_siestes_courtes", text: "- On **retrouve** alors un **cercle vicieux** :" },
                { type: "vicious_circle", showIfPb: "rythme_te_court_siestes_courtes", steps: ["Courte sieste", "Fatigue", "Sécrétion de cortisol", "Difficulté à rester [endormi_endormie]"] },
