            ...
            blocks: [
              {
                ...
                items: [
                  ...
                  { id: "env_obs", emoji: "🌑", label: "Obscurité insuffisante", pb: "env_obscurite", blocks: [
                    ...
                    { type: "normal", _leftTitle: "Conseils", text: "- Je vous encourage à avoir un \"**objectif obscurité\" de 100% :**\n  - Je vous conseille de **limiter les veilleuses ….** SAUF si **mention de \"peur du noir\"**\n  - Je vous invite à faire attention :\n    - A la l**umière sous la porte** ⇒ serviette roulée\n    - Au **point lumineux du babyphone/multiprise**… ⇒ Mettre une gommette ou un lange\n- Je vous invite à **vous exposer à la lumière naturelle** (notamment le matin) pour **re-synchroniser son horloge biologique** *(ex : balade, ouverture des volets…)*\n\n<details style=\"border:2px solid #fcd34d;border-radius:10px;background:#fffbeb;padding:10px 14px;margin:10px 0\"><summary style=\"cursor:pointer;font-weight:800;color:#7c2d12;user-select:none;list-style:none;display:flex;align-items:center;justify-content:space-between;gap:10px\"><span>💡 Pas de confusion jour/nuit après 8 semaines</span><span style=\"font-size:13px\">▾</span></summary><ul style=\"margin:10px 0 0;padding-left:24px;list-style:disc\"><li>Pas de confusion jour/nuit après 8 semaines, le cycle circadien est en place, avec la sécrétion des bonnes hormones au bon moment de la journée</li></ul></details>\n\n<details style=\"border:2px solid #fcd34d;border-radius:10px;background:#fffbeb;padding:10px 14px;margin:10px 0\"><summary style=\"cursor:pointer;font-weight:800;color:#7c2d12;user-select:none;list-style:none;display:flex;align-items:center;justify-content:space-between;gap:10px\"><span>💡 La peur du noir</span><span style=\"font-size:13px\">▾</span></summary><ul style=\"margin:10px 0 0;padding-left:24px;list-style:disc\"><li>La peur du noir n'apparait pas avant 2,5-3 ans voire jamais (dès fois 18 mois)</li></ul></details>\n\n- **💡 Vous pourrez ré-introduire** de la lumière **si les siestes sont longues** et se **passent bien**\n- 💡 **Comment faire ?**\n  - Feuille d'aluminium + spray d'eau\n  - Carton\n  - Rideaux occultants *(ex : Tomme Tippee à ventouses)*" }
                  ] },
