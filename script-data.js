          ...
          { id: "rythme_siestes", label: "Siestes", cardLabel: "Siestes", cardEmoji: "💤",
            ...
            blocks: [
              ...
              { type: "normal", showIfSieste: "2-4m",
                text: "<div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:12px 14px;font-size:14px;line-height:1.6;color:#7c2d12\"><div style=\"font-weight:800;font-size:15px;margin-bottom:8px\">💡 Temps d'alim = début temps d'éveil</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Je vous conseille de proposer un <strong>temps d'alimentation</strong> <strong>au début</strong> de <strong>chaque temps d'éveil,</strong><br>⇒ C'est le <strong>moment idéal</strong> pour lui, puisqu'il aura toute l'<strong>énergie nécessaire</strong> pour <strong>boire efficacement</strong> !</li></ul></div>",
                trailingInfoButtons: [
                  {
