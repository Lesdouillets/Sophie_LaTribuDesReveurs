      ...
      { type: "question", _leftTitle: "Objectifs OK ?", _leftTitleStyle: "background:#2d3f5c;color:#fff", text: "Est-ce que j'ai <strong>répondu à vos objectifs</strong> ?", embeddedActions: [
        {
          ...
          blocks: [
            ...
            { type: "question", _leftTitle: "Dernière question", _leftTitleStyle: "background:#2d3f5c;color:#fff", text: "Moi, j'ai une **dernière question** pour VOUS qui est **très importante** :\n⇒ Comment vous **vous sentez LÀ,** à **l'idée de mettre** tout ceci **en place** ?" },
