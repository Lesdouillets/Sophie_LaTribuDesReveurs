  ...
  conditional: [
    ...
    // ─── NUTRITION : COURBE DE POIDS QUI DIMINUE ─────────
    {
      ...
      blocks: [
        ...
        { type: "option_banner", leverId: "nutri_tetee_longue", emoji: "🤱", showIfPb: "nutri_tetee_longue", variant: "orange" },
        ...
        { type: "option_banner", leverId: "nutri_tetee_greve", emoji: "🙅", showIfPb: "nutri_tetee_greve", variant: "orange" },
        { type: "normal", showIfPb: "nutri_tetee_greve", text: "- Vous m'avez aussi parlé du refus de certaines tétées" },
        { type: "option_banner", leverId: "nutri_tetee_mode_garde", emoji: "👶", showIfPb: "nutri_tetee_mode_garde", variant: "orange" },
