  ...
  required: [
    ...
    // ── III. DÉCOUVERTE ────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { type: "normal", text: "<div class=\"decouverte-steps\" data-active-step=\"1\" style=\"display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;align-items:stretch\"><div class=\"dec-step-col\" data-step=\"1\" onclick=\"setDecouverteStep(this, 1)\" style=\"cursor:pointer;border:2px solid #cbd5e0;border-radius:14px;padding:12px;background:#ffffff;transition:all 0.15s;display:flex;flex-direction:column\"><div class=\"dec-step-title\" data-step=\"1\" style=\"padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;margin-bottom:10px;transition:all 0.15s\">📊 Lecture des courbes</div><div class=\"dec-step-content\" data-step=\"1\" style=\"transition:opacity 0.15s\"><div style=\"padding:0 4px\">• On va maintenant <strong>regarder les courbes</strong></div><div style=\"background:#fdf0f0;border:2.5px solid #e8a0a0;border-radius:10px;padding:12px 14px;margin-top:4px;font-size:14px;line-height:1.4\">❓ Est-ce que vous pourriez <strong>me donner votre taille à TOUS les 2</strong> ?<br>Avez-vous des <strong>personnes très GRANDES dans vos familles</strong> ?</div><div style=\"background:#fdf0f0;border:2.5px solid #e8a0a0;border-radius:10px;padding:12px 14px;margin-top:4px;font-size:14px;line-height:1.4\">❓ Avez-vous les <strong>courbes devant vous</strong> ?<br>On va <strong>commencer</strong> par lire la <strong>courbe du périmètre crânien</strong></div></div></div><div class=\"dec-step-col\" data-step=\"2\" onclick=\"setDecouverteStep(this, 2)\" style=\"cursor:pointer;border:2px solid #cbd5e0;border-radius:14px;padding:12px;background:#ffffff;transition:all 0.15s;display:flex;flex-direction:column\"><div class=\"dec-step-title\" data-step=\"2\" style=\"padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;margin-bottom:10px;transition:all 0.15s\">📋 Tableau de suivi du sommeil</div><div class=\"dec-step-content\" data-step=\"2\" style=\"transition:opacity 0.15s\"><div style=\"padding:0 4px\">• Maintenant, on va <strong>lire ensemble</strong> le <strong>tableau de suivi du sommeil</strong> que vous avez rempli</div></div></div><div class=\"dec-step-col\" data-step=\"3\" onclick=\"setDecouverteStep(this, 3)\" style=\"cursor:pointer;border:2px solid #cbd5e0;border-radius:14px;padding:12px;background:#ffffff;transition:all 0.15s;display:flex;flex-direction:column\"><div class=\"dec-step-title\" data-step=\"3\" style=\"padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;margin-bottom:10px;transition:all 0.15s\">📸 Photos de la chambre</div><div class=\"dec-step-content\" data-step=\"3\" style=\"transition:opacity 0.15s\"><div style=\"padding:0 4px\">• On va maintenant <strong>regarder rapidement les photos</strong> de la chambre</div></div></div></div>" },
    ...
    // ── IV. OBJECTIFS ──────────────────────────────────────
    {
      ...
      blocks: [
        ...
        {
          type: "option", label: "Position ventrale – Souhait de garder ou non ?", style: "purple", hideIfPb: "souhait_position_dorsale",
          blocks: [
    ...
    // ── VII. PLUSIEURS CHEMINS POSSIBLES ───────────────────
    {
      ...
      blocks: [
        ...
        { type: "question", text: "Avec tout ça en tête, qu'est-ce qui vous **semblerait le + juste** pour vous et pour [prénom_enfant] :\n- **Quelque chose** de **plutôt progressif,**\n- Ou **quelque chose** de **+ rapide?**" },
