    ...
    categories: [
      {
        ...
        children: [
          { id: "conf_aplv", label: "APLV", cardLabel: "APLV suspectée", cardEmoji: "🌿", autoCheckIfPbs: ["allergie_seule", "rgo_allergie"], blocks: [
            ...
            { type: "normal", showIfAlim: ["Allaitement mixte", "Biberon lait infantile"], text: "- Je vous conseille de demander à votre médecin de privilégier **directement un lait de riz** (sans passer par un lait avec des PLV) pour gagner du temps" },
