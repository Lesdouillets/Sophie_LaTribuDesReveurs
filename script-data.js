        ...
        children: [
          ...
          { id: "rythme_siestes", label: "Siestes", cardLabel: "Siestes", cardEmoji: "💤",
            ...
            blocks: [
              ...
              { type: "normal", _leftTitle: "Comment faire?", showIfSieste: "2-4m", text: "<div style=\"display:grid;grid-template-columns:130px 1fr;gap:0;margin-bottom:14px;border-radius:8px;overflow:hidden;border:1.5px solid #94a3b8\"><div style=\"font-size:13px;font-weight:800;color:#475569;background:#f1f5f9;padding:14px 10px;text-align:center;display:flex;align-items:center;justify-content:center;letter-spacing:0.2px\">Endormissement</div><div style=\"background:white;padding:12px 16px\"><ul style=\"margin:0 0 8px 22px;padding:0;list-style:disc;line-height:1.7\"><li>Essayer <strong>pendant 1h10</strong></li><li>Faire une <strong>pause de 20-30 min</strong> en dehors de la chambre</li><li><strong>Recommencez</strong> pendant <strong>30min</strong> ...<strong>ainsi de suite :  vous essayez</strong> 30min puis 20min de pause…</li></ul><div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:10px 14px;margin-top:8px;font-size:13.5px;line-height:1.55;color:#7c2d12\">💡 <strong>Si trop difficile pour le parent :</strong><ul style=\"margin:6px 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li><strong>OK</strong> pour revenir à de la <strong>dépendance</strong> (poussette, bras, sein, voiture...)</li><li>⚠️Soyez toujours <strong>cohérent</strong> tout du long de la sieste</li></ul></div></div></div><div style=\"display:grid;grid-template-columns:130px 1fr;gap:0;border-radius:8px;overflow:hidden;border:1.5px solid #94a3b8\"><div style=\"font-size:13px;font-weight:800;color:#475569;background:#f1f5f9;padding:14px 10px;text-align:center;display:flex;align-items:center;justify-content:center;letter-spacing:0.2px\">Rendormissement</div><div style=\"background:white;padding:12px 16px;display:flex;flex-direction:column;gap:10px\"><div style=\"display:grid;grid-template-columns:110px 1fr;gap:0;border-radius:6px;overflow:hidden;border:1px solid #a78bfa\"><div style=\"font-size:12.5px;font-weight:800;color:#6d28d9;background:#ede9fe;padding:10px 8px;text-align:center;display:flex;align-items:center;justify-content:center;line-height:1.3\">⏱ Réveil avant 1h</div><div style=\"background:white;padding:10px 14px\"><div style=\"font-size:13.5px;line-height:1.65\">Si vous <strong>connaissez</strong> les <strong>durées de ces cycles</strong>, vous pouvez :</div><ul style=\"margin:6px 0 10px 22px;padding:0;list-style:disc;line-height:1.7\"><li><strong>rentrer délicatement</strong> dans la chambre quelques minutes avant</li><li><strong>refermez la porte</strong> pour l'obscurité,</li><li><strong>être prêt à rallonger</strong> la sieste <strong>rapidement</strong> (avec des « chutt », des caresses, pour que son <strong>corps</strong> <strong>apprenne</strong> à <strong>dormir plus longtemps</strong>)</li></ul><div style=\"background:white;border-left:3px solid #166534;border-radius:0 6px 6px 0;padding:8px 12px;margin-top:8px\"><div style=\"font-weight:700;color:#166534;font-size:13.5px;margin-bottom:4px\">Fortes émotions :</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Essayez <strong>15 min</strong></li><li>Si <strong>pas de rendormissement</strong> ⇒ <strong>Le lever</strong> (+ rituel du lever)</li></ul><div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:8px;padding:8px 12px;margin-top:8px;font-size:13px;line-height:1.55;color:#7c2d12\">⚠️ <strong>[Sil_Sielle] ne s'endort jamais après les 15min :</strong><ul style=\"margin:4px 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Proposer une <strong>dépendance + forte</strong> (poussette/portage/voiture)</li></ul></div></div><div style=\"background:white;border-left:3px solid #166534;border-radius:0 6px 6px 0;padding:8px 12px;margin-top:10px\"><div style=\"font-weight:700;color:#166534;font-size:13.5px;margin-bottom:4px\">Gazouillement / chouine un peu :</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Ne <strong>pas intervenir</strong> (pendant 1h max sauf si émotions)</li></ul></div></div></div><div style=\"display:grid;grid-template-columns:110px 1fr;gap:0;border-radius:6px;overflow:hidden;border:1px solid #a78bfa\"><div style=\"font-size:12.5px;font-weight:800;color:#6d28d9;background:#ede9fe;padding:10px 8px;text-align:center;display:flex;align-items:center;justify-content:center;line-height:1.3\">⏱ Réveil entre 1h-1h10</div><div style=\"background:white;padding:10px 14px\"><div style=\"background:white;border-left:3px solid #166534;border-radius:0 6px 6px 0;padding:8px 12px\"><div style=\"font-weight:700;color:#166534;font-size:13.5px;margin-bottom:4px\">[Sil_Sielle] prolonge d'<strong>AUTRES</strong> siestes :</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>⇒ <strong>le lever</strong> (+ rituel du lever)</li></ul></div><div style=\"background:white;border-left:3px solid #166534;border-radius:0 6px 6px 0;padding:8px 12px;margin-top:10px\"><div style=\"font-weight:700;color:#166534;font-size:13.5px;margin-bottom:4px\">[Sil_Sielle] reste à 1h de sieste pour toutes ses siestes :</div><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li>Agir comme un <strong>réveil de -1h</strong> pour les <strong>2 premières siestes</strong> de la journée</li></ul></div></div></div><div style=\"display:grid;grid-template-columns:110px 1fr;gap:0;border-radius:6px;overflow:hidden;border:1px solid #a78bfa\"><div style=\"font-size:12.5px;font-weight:800;color:#6d28d9;background:#ede9fe;padding:10px 8px;text-align:center;display:flex;align-items:center;justify-content:center;line-height:1.3\">⏱ Réveil entre 1h30- 2h30</div><div style=\"background:white;padding:10px 14px\"><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li><strong>Le lever</strong> (+ rituel du lever)</li></ul></div></div><div style=\"display:grid;grid-template-columns:110px 1fr;gap:0;border-radius:6px;overflow:hidden;border:1px solid #a78bfa\"><div style=\"font-size:12.5px;font-weight:800;color:#6d28d9;background:#ede9fe;padding:10px 8px;text-align:center;display:flex;align-items:center;justify-content:center;line-height:1.3\">⏱ Dort + de 4h</div><div style=\"background:white;padding:10px 14px\"><ul style=\"margin:0 0 0 22px;padding:0;list-style:disc;line-height:1.7\"><li><strong>Le réveiller</strong> (+ rituel du lever)</li></ul></div></div></div></div>" },
