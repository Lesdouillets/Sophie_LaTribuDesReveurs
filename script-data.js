  ...
  required: [
    ...
    // ── III. DÉCOUVERTE ────────────────────────────────────
    {
      ...
      blocks: [
        ...
        { type: "normal", text: "<div style=\"display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:auto auto;gap:10px 14px;align-items:start\">\n  <div style=\"background:linear-gradient(90deg,#1a2a42,#4a5f82);color:white;padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;grid-row:1\">📊 Lecture des courbes</div>\n  <div style=\"background:linear-gradient(90deg,#1a2a42,#4a5f82);color:white;padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;grid-row:1\">📋 Tableau de suivi du sommeil</div>\n  <div style=\"background:linear-gradient(90deg,#1a2a42,#4a5f82);color:white;padding:10px 14px;border-radius:10px;font-weight:900;font-size:14px;text-align:center;display:flex;align-items:center;justify-content:center;min-height:48px;grid-row:1\">📸 Photos de la chambre</div>\n  <div style=\"grid-row:2\">\n    <div style=\"padding:0 4px\">- On va maintenant <strong>regarder les courbes</strong></div>\n    <div style=\"background:#fdf0f0;border:2.5px solid #e8a0a0;border-radius:10px;padding:12px 14px;margin-top:10px;font-size:14px;line-height:1.6\">❓ Est-ce que vous pourriez <strong>me donner votre taille à TOUS les 2</strong> ?<br>Avez-vous des <strong>personnes très GRANDES dans vos familles</strong> ?</div>\n    <div style=\"background:#fdf0f0;border:2.5px solid #e8a0a0;border-radius:10px;padding:12px 14px;margin-top:10px;font-size:14px;line-height:1.6\">❓ Avez-vous les <strong>courbes devant vous</strong> ?<br>On va <strong>commencer</strong> par lire la <strong>courbe du périmètre crânien</strong></div>\n  </div>\n  <div style=\"grid-row:2\">\n    <div style=\"padding:0 4px\">- Maintenant, on va <strong>lire ensemble</strong> le <strong>tableau de suivi du sommeil</strong> que vous avez rempli</div>\n  </div>\n  <div style=\"grid-row:2\">\n    <div style=\"padding:0 4px\">- On va maintenant <strong>regarder rapidement les photos</strong> de la chambre</div>\n  </div>\n</div>" },
