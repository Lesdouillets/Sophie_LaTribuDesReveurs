          ...
          { id: "rythme_emploi_du_temps", label: "Emploi du temps", cardLabel: "Emploi du temps", cardEmoji: "📅",
            ...
            blocks: [
              ...
              { type: "normal", showIfSieste: "2-4m",
                text: "<div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:12px 16px;margin:14px 0 10px 0;font-size:14px;line-height:1.6;color:#7c2d12;display:flex;align-items:flex-start;gap:8px\"><div style=\"flex-shrink:0\">💡</div><div style=\"flex:1\"><div style=\"margin-bottom:8px\">Un <strong>TE commence</strong> à partir du moment où l'enfant <strong>s'est réveillé</strong> (donc un <strong>rallongement</strong> de sieste qui n'a <strong>pas fonctionné</strong> <strong>FAIT PARTIE du TE</strong>)</div><div style=\"margin-bottom:10px\"><strong>SAUF</strong> pour le 1er TE : il commence à partir de la <strong>sortie du lit</strong>, pour <strong>donner un tempo</strong> à la journée</div><ul style=\"margin:0;padding-left:22px;list-style:disc;line-height:1.6\"><li>Tout ce qui va se passer <strong>AVANT l'heure du réveil le matin</strong>, sera <strong>considéré</strong> comme un <strong>réveil matinal</strong><br>⇒ et je vous <strong>indiquerai</strong> la <strong>démarche à suivre</strong> dans <strong>ce cas-là</strong></li></ul></div></div><div style=\"background:#fef9e0;border:1.5px solid #f5d778;border-radius:10px;padding:12px 16px;margin:10px 0;font-size:14px;line-height:1.6;color:#7c2d12\"><div style=\"margin-bottom:10px\">⚠️ <strong>Je vous encourage</strong> à <strong>donner</strong> un <strong>temps d'alimentation</strong> <strong>au réveil</strong> de chaque sieste<br>⇒ c'est le <strong>moment idéal</strong>, car votre enfant a alors de <strong>suffisamment d'énergie</strong> pour <strong>boire efficacement</strong>.</div><div>⚠️ Je vous invite aussi à <strong>donner 1 bib/tétée SUPPLÉMENTAIRE</strong> lors du <strong>rituel du soir</strong><br>⇒ C'est-à-dire qu'il aura <strong>2 bib/tétées</strong> sur le <strong>dernier temps d'éveil</strong></div></div>"
              },
              // ─── 4-6 mois (3 siestes) ─────────────────────────────────────
