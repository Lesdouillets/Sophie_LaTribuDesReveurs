      ...
      },
      {
        ...
        children: [
          { id: "nutri_lait", label: "Lait", cardLabel: "Lait", cardEmoji: "🍼",
            ...
            { type: "normal", _leftTitle: "Nutrition la nuit", _leftTitleStyle: "background:#5d7a99;color:#fff;--cat-main:#5d7a99", text: "<div style=\"text-align:center;font-size:26px;line-height:1\">🌛</div>" },
            {
