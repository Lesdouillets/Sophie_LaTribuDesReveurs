  ...
  conditional: [
    ...
    // ─── NUTRITION : COURBE DE POIDS QUI DIMINUE ─────────
    {
      ...
      blocks: [
        ...
        { type: "normal", showIfPb: "nutri_inversion_jour_nuit", text: "- 🌛 L'**objectif** serait **aussi** de **réduire les réveils nocturnes** car il **semble utiliser la nuit** pour **compléter ce qu'**il ne **prend pas** encore en **journée**" },
